...
type BookRepository interface {          //interfeys gerekmi su yerde. Service-em su zatlary etyana menzeya
	...
	GetBookByID(id int) (*models.Book, error)  // database kitapyn id'sine gora alya
	CreateBook(book *models.Book) error    //database taze kitap gosyar. Id boyunca
	UpdateBook(id int, book *models.Book) error // database kitapyn id'sine gora kitaby obnowit etya
	DeleteBook(id int) error // id boyunca kitaby ayyryar
}
...
func (r *bookRepository) GetBookByID(id int) (*models.Book, error) {   
	var book models.Book  
	 // Boook strukturady tiply kitaplary book peremenna dakyar
...
func (r *bookRepository) UpdateBook(id int, book *models.Book) error {   //UpdateBook su yerde islemek ucin da.
...
func (r *bookRepository) DeleteBook(id int) error {  // Aslynda dusunip otyryn yone dlya utocneniya. Acylan baza deletebookyng tipynda bolya.Name ucin? Cunlasdyryp dusundiray! Mozhet men yalnysh dusunup otyrandyryn
